    ...
    <section id="certifications" className="py-24">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {certifications.map((cert, idx) => (
          <motion.div
            key={cert.name}
            className="glass-panel flex flex-col justify-between rotate-[-1deg] rounded-xl border border-white/5 p-5 transition hover:-translate-y-2 hover:rotate-1"
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-6 inline-block w-fit text-[0.6rem] uppercase tracking-[0.5em] text-stRed transition-colors hover:text-white"
            >
              Verify →
            </a>
          </motion.div>
